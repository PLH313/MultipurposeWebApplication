...
function SignInForm() {
    ...
    return (
        <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-xl shadow-lg">
            ...
            {verified && (
                <div className="bg-green-100 text-green-800 p-4 mb-4 rounded-lg text-sm">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                ...
                <div>
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-lg font-medium text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {isLoading ? (
